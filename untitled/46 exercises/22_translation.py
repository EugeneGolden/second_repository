...
ROT-13 ("rotate by 13 places") is a widely used example of a Caesar cipher where the
...
print translate(cipher, 'Pnrfne pvcure? V zhpu cersre Pnrfne fnynq!')